...
A API atualmente usa autenticação mock para desenvolvimento. Futuramente será integrada com um provedor de autenticação.
...
| `VITE_SUPABASE_URL` | URL do Supabase | Opcional |
...
- [ ] Integrar APIs de pagamento (Stripe)
