...
export const requireMasterOrStore = requireRole([UserRole.MASTER, UserRole.STORE])
export const requireAnyRole = requireRole([UserRole.PLAYER, UserRole.MASTER, UserRole.STORE, UserRole.ADMIN])