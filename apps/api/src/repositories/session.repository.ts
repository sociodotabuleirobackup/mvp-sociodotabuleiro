...
export class SessionRepository {
  ...
  async findMany(filters: SessionFilters = {}) {
    ...
    if (filters.gameSystem) where.gameSystem = { contains: filters.gameSystem, mode: 'insensitive' }
    ...
    if (filters.scheduledAfter || filters.scheduledBefore) {
      where.scheduledAt = {}
      if (filters.scheduledAfter) where.scheduledAt.gte = filters.scheduledAfter
      if (filters.scheduledBefore) where.scheduledAt.lte = filters.scheduledBefore
    }
