...
export class BookingService {
  ...
  async confirmBooking(bookingId: string, userId: string) {
    ...
    return this.bookingRepository.updateStatus(bookingId, BookingStatus.CONFIRMED)
  }
  ...
  async cancelBooking(bookingId: string, userId: string) {
    ...
    return this.bookingRepository.updateStatus(bookingId, BookingStatus.CANCELLED)
  }
}