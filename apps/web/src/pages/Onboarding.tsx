        ...
        <div className="mt-8">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-[10px] text-gray-600 uppercase tracking-widest mb-3">
              Simular Login como (MVP)
            </p>
            <div className="flex justify-center gap-2">
              <button
                onClick={() => onLogin(UserRole.MASTER)}
                className="px-3 py-1 rounded bg-white/5 hover:bg-white/10 text-gray-300 text-xs border border-white/5 hover:border-primary/30 transition-all"
              >
                Mestre
              </button>
              <button
              ...
              <button
                onClick={() => onLogin(UserRole.VENUE)}
                className="px-3 py-1 rounded bg-white/5 hover:bg-white/10 text-gray-300 text-xs border border-white/5 hover:border-primary/30 transition-all"
              >
                Lojista
              </button>
